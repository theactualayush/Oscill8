...
def results_to_dataframe(
    ...
    for result in results:
        ...
        row = {
            ...
            "lower_percentile": headline.lower_percentile,
            "upper_percentile": headline.upper_percentile,
            "range_position_robust": headline.range_position_robust,
            "z_score": headline.z_score,
            "abs_z_score": metric_value(headline, "abs_z_score"),
            ...
            "oscillation_count": headline.oscillation_count,
            "mean_abs_change_price": headline.mean_abs_change_price,
            "mean_abs_change_bp": headline.mean_abs_change_bp,
